...
<?php $con=mysqli_connect("localhost","root","1234","sourcecodester_jobportaldb") ?>
<?php
  ...
  function GetSQLValueString($theValue, $theType, $theDefinedValue = "", $theNotDefinedValue = "") 
{
    ...
    switch ($theType) {
        case "text":
            $theValue = ($theValue != "") ? "'" . mysqli_real_escape_string($con, $theValue) . "'" : "NULL";
            break;    
        case "long":
        case "int":
...
<title>JOB PORTAL BY Indrajit</title>
...
$con = mysqli_connect("localhost","root","1234","sourcecodester_jobportaldb");
